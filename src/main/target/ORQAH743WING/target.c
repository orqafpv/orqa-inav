...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM15,CH1, PE5,  TIM_USE_OUTPUT_AUTO, 0, 7),    // S3
    DEF_TIM(TIM15,CH2, PE6,  TIM_USE_OUTPUT_AUTO, 0, 0),    // S4
    DEF_TIM(TIM4, CH4, PD15, TIM_USE_OUTPUT_AUTO, 0, 0),    // S5
    DEF_TIM(TIM1, CH4, PE14, TIM_USE_OUTPUT_AUTO, 0, 3),    // S6  
    DEF_TIM(TIM1, CH2, PE11, TIM_USE_OUTPUT_AUTO, 0, 1),    // S7 
    DEF_TIM(TIM5, CH2, PA1,  TIM_USE_OUTPUT_AUTO, 0, 6),    // S8  
    DEF_TIM(TIM3, CH4, PB1,  TIM_USE_OUTPUT_AUTO, 0, 0),    // S9 
    DEF_TIM(TIM3, CH3, PB0,  TIM_USE_OUTPUT_AUTO, 0, 0),    // S10
    //DEF_TIM(TIM1, CH1, PB13, TIM_USE_OUTPUT_AUTO, 0, 0),    // PWM

    DEF_TIM(TIM1, CH1, PA8,  TIM_USE_OUTPUT_AUTO, 0, 0),    // M1 
    DEF_TIM(TIM4, CH3, PD14, TIM_USE_OUTPUT_AUTO, 0, 4),    // M2
    DEF_TIM(TIM5, CH1, PA0,  TIM_USE_OUTPUT_AUTO, 0, 5),    // M3
